...
możemy otworzyć go za pomocą mcedita
...
wszystko w porządku jest gdy otrzymamy takie dane (status: NOERROR)  z polecenia  dig -x 
127.0.0.1
...
następnie tworzymy ponownie ten plik w mcedicie  
...
powinniśmy jeszcze zablokować plik przed nadpisywaniem wpisując sudo chattr +i 
/etc/resolv.conf
